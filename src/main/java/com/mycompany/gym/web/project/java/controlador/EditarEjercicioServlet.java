...
public class EditarEjercicioServlet extends HttpServlet {
    ...
    private void redirigirAeditarEjercicio(HttpServletRequest request, HttpServletResponse response, Ejercicio ejercicio, List<ParteDelCuerpo> partesDelCuerpo, List<Equipo> equipos, String equipoNombre) throws ServletException, IOException {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            Ejercicio ejercicio = ejercicioDAO.getById(ejercicioId); // obtengo el ejercicio a editar
            int parteDelCuerpoID = parteDelCuerpoDAO.getByName(musculoPrincipal).getParteDelCuerpoID(); // obtengo el id de la parte del cuerpo
            int equipoID = equipoDAO.getByName(equipoNombre).getEquipoID(); // obtengo el id del equipo
            ...
            ejercicioDAO.update(ejercicio); // actualizo el ejercicio en la base de datos
